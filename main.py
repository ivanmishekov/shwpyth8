...
while True:
    ...
    if mode == 1:
        ...
        num = int(input('Введите номер нужной строки для изменения: ')) - 1
        functions.change_data(num)
    elif mode == 5:
        num = int(input('Введите номер нужной строки для удаления: ')) - 1
        functions.del_data(num)
    else:
        break
